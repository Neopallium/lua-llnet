...
"	local obj_type = obj_mt['.type']\n"
"	local obj_ctype = ffi.typeof(\"LSocketFD_t\")\n"
"	_ctypes.LSocketFD = obj_ctype\n"
"	_type_names.LSocketFD = tostring(obj_ctype)\n"
"\n"
...
"-- method: IP_RECVOPTS\n"
"if (_M.Options.IP_RECVOPTS) then\n"
...
"if (_M.Options.IP_MULTICAST_TTL) then\n"
...
"\n"
"-- method: IP_FREEBIND\n"
"if (_M.Options.IP_FREEBIND) then\n"
...
"if (_M.Options.IP_MTU_DISCOVER) then\n"
...
"if (_M.Options.IP_ROUTER_ALERT) then\n"
...
"if (_M.Options.IP_RECVRETOPTS) then\n"
...
"if (_M.Options.IP_RECVORIGDSTADDR) then\n"
...
"if (_M.Options.IPV6_MULTICAST_HOPS) then\n"
...
"\n"
"-- method: IPV6_RECVERR\n"
"if (_M.Options.IPV6_RECVERR) then\n"
...
"if (_M.Options.IPV6_CHECKSUM) then\n"
...
"if (_M.Options.IPV6_MULTICAST_LOOP) then\n"
...
"if (_M.Options.IPV6_MULTICAST_IF) then\n"
...
"if (_M.Options.IPV6_RECVRTHDR) then\n"
...
"if (_M.Options.IPV6_MTU_DISCOVER) then\n"
...
"if (_M.Options.IPV6_UNICAST_HOPS) then\n"
...
"\n"
"-- method: IPV6_NEXTHOP\n"
"if (_M.Options.IPV6_NEXTHOP) then\n"
...
"if (_M.Options.IPV6_RECVHOPLIMIT) then\n"
...
"if (_M.Options.IPV6_HOPLIMIT) then\n"
...
"if (_M.Options.IPV6_ADDRFORM) then\n"
...
"\n"
"-- method: IPV6_V6ONLY\n"
"if (_M.Options.IPV6_V6ONLY) then\n"
...
"if (_M.Options.IPV6_RECVDSTOPTS) then\n"
...
"\n"
"-- method: IPV6_TCLASS\n"
"if (_M.Options.IPV6_TCLASS) then\n"
...
"if (_M.Options.IPV6_RECVTCLASS) then\n"
...
"if (_M.Options.IPV6_RECVPKTINFO) then\n"
...
"if (_M.Options.IPV6_ROUTER_ALERT) then\n"
...
"if (_M.Options.SO_SNDBUFFORCE) then\n"
...
"\n"
"-- method: SO_TIMESTAMP\n"
"if (_M.Options.SO_TIMESTAMP) then\n"
...
"\n"
"-- method: SO_NO_CHECK\n"
"if (_M.Options.SO_NO_CHECK) then\n"
...
"\n"
"-- method: SO_BSDCOMPAT\n"
"if (_M.Options.SO_BSDCOMPAT) then\n"
...
"\n"
"-- method: SO_REUSEADDR\n"
"if (_M.Options.SO_REUSEADDR) then\n"
...
"if (_M.Options.SO_TIMESTAMPING) then\n"
...
"if (_M.Options.SO_TIMESTAMPNS) then\n"
...
"if (_M.Options.SO_BINDTODEVICE) then\n"
...
"if (_M.Options.SO_RCVBUFFORCE) then\n"
...
"\n"
"-- method: SO_SNDLOWAT\n"
"if (_M.Options.SO_SNDLOWAT) then\n"
...
"\n"
"-- method: SO_OOBINLINE\n"
"if (_M.Options.SO_OOBINLINE) then\n"
...
"\n"
"-- method: SO_RCVLOWAT\n"
"if (_M.Options.SO_RCVLOWAT) then\n"
...
"\n"
"-- method: SO_PASSCRED\n"
"if (_M.Options.SO_PASSCRED) then\n"
...
"\n"
"-- method: SO_PRIORITY\n"
"if (_M.Options.SO_PRIORITY) then\n"
...
"\n"
"-- method: SO_BROADCAST\n"
"if (_M.Options.SO_BROADCAST) then\n"
...
"\n"
"-- method: SO_KEEPALIVE\n"
"if (_M.Options.SO_KEEPALIVE) then\n"
...
"\n"
"-- method: TCP_KEEPIDLE\n"
"if (_M.Options.TCP_KEEPIDLE) then\n"
...
"\n"
"-- method: TCP_QUICKACK\n"
"if (_M.Options.TCP_QUICKACK) then\n"
...
"if (_M.Options.TCP_CONGESTION) then\n"
...
"if (_M.Options.TCP_WINDOW_CLAMP) then\n"
...
"if (_M.Options.TCP_DEFER_ACCEPT) then\n"
...
"\n"
"-- method: TCP_NODELAY\n"
"if (_M.Options.TCP_NODELAY) then\n"
...
"\n"
"-- method: TCP_KEEPCNT\n"
"if (_M.Options.TCP_KEEPCNT) then\n"
...
"\n"
"-- method: TCP_LINGER2\n"
"if (_M.Options.TCP_LINGER2) then\n"
...
"if (_M.Options.TCP_KEEPINTVL) then\n"
...
"if (_M.Options.SO_ACCEPTCONN) then\n"
...
"-- method: SO_PROTOCOL\n"
"if (_M.Options.SO_PROTOCOL) then\n"
...
static const reg_sub_module reg_sub_modules[] = {
  ...
  { &(obj_type_Protocols), REG_META, obj_Protocols_pub_funcs, obj_Protocols_methods, obj_Protocols_metas, NULL, NULL, obj_Protocols_constants, 0},
  { &(obj_type_Services), REG_META, obj_Services_pub_funcs, obj_Services_methods, obj_Services_metas, NULL, NULL, obj_Services_constants, 0},
  { &(obj_type_LSockAddr), REG_OBJECT, obj_LSockAddr_pub_funcs, obj_LSockAddr_methods, obj_LSockAddr_metas, obj_LSockAddr_bases, obj_LSockAddr_fields, obj_LSockAddr_constants, 0},
  { &(obj_type_Options), REG_PACKAGE, obj_Options_pub_funcs, NULL, NULL, NULL, NULL, obj_Options_constants, 1},
  { &(obj_type_SetSocketOption), REG_PACKAGE, obj_SetSocketOption_pub_funcs, NULL, NULL, NULL, NULL, obj_SetSocketOption_constants, 0},
  { &(obj_type_GetSocketOption), REG_PACKAGE, obj_GetSocketOption_pub_funcs, NULL, NULL, NULL, NULL, obj_GetSocketOption_constants, 0},
  { &(obj_type_LSocketFD), REG_OBJECT, obj_LSocketFD_pub_funcs, obj_LSocketFD_methods, obj_LSocketFD_metas, obj_LSocketFD_bases, obj_LSocketFD_fields, obj_LSocketFD_constants, 0},
